...
import { idlFactory } from './homework_canister.did.js';
export { idlFactory } from './homework_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HOMEWORK_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./homework_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the homework_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./homework_canister.did.js")._SERVICE>}
 */
export const homework_canister = createActor(canisterId);
