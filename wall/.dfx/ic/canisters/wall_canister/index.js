...
import { idlFactory } from './wall_canister.did.js';
export { idlFactory } from './wall_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WALL_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wall_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wall_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wall_canister.did.js")._SERVICE>}
 */
export const wall_canister = createActor(canisterId);
