...
import { idlFactory } from './calculator_canister.did.js';
export { idlFactory } from './calculator_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CALCULATOR_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./calculator_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the calculator_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./calculator_canister.did.js")._SERVICE>}
 */
export const calculator_canister = createActor(canisterId);
